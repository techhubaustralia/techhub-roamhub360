          ...
          >
            ...
            <div className="flex items-center gap-2 border-b px-4 py-3">
              ...
              <div className="flex items-center gap-2 font-heading text-[15px] font-bold">
                ...
                {view === "support" ? "Contact support"
                  ...
                  : view === "article" ? "Help article" : "Help & support"}
              </div>
            ...
            {(view === "list" || view === "article") && (
              <div className="flex gap-2 border-t p-3">
                ...
                {/* One home for requests — the Support Centre page. The panel is the quick entry
                    point; tracking/replying lives on /support so there's a single implementation. */}
                <a
                  href="/support"
