...
// Self-serve trial form. Rendered by app/signup/page.tsx ONLY when ALLOW_PUBLIC_SIGNUP=true; the
// server route refuses otherwise, so this never shows a form that can't succeed.
